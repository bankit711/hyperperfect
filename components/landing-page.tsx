    ...
    <div className="relative font-dm bg-pat-paper text-pat-ink">
      ...
      <section className="px-4 py-20 md:py-24 bg-pat-paper2/50 border-t border-pat-terra-100">
        <div className="container mx-auto max-w-5xl">
          <div className="text-sm font-medium uppercase tracking-[0.18em] text-pat-terra-600 mb-10">
          ...
          <div className="grid gap-12 md:grid-cols-2 md:gap-14">
            ...
            >
              <span aria-hidden className="block font-serif text-7xl leading-none text-pat-terra-200 select-none -mb-3">
                &ldquo;
              </span>
              <blockquote className="font-serif text-xl md:text-2xl leading-snug tracking-tight text-pat-ink">
                Honestly <span className="italic text-pat-terra-600">better than any AI I&apos;ve ever used</span>,
                including Claude. It&apos;s essentially replaced a reporting manager, a sales assistant, and a
                personal assistant. I run four companies, and it&apos;s cut my workload down substantially.
              ...
              <figcaption className="mt-7">
                <span className="block font-serif text-xl text-pat-ink">Matt Appel</span>
                <span className="mt-1 block text-sm uppercase tracking-[0.14em] text-pat-ink-500">
                  Founder, Automate Your Life
                </span>
              </figcaption>
            </motion.figure>
            ...
            >
              ...
              <blockquote className="font-serif text-xl md:text-2xl leading-snug tracking-tight text-pat-ink">
                As a business owner, my scarcest resource is time. Patricia was{" "}
                <span className="italic text-pat-terra-600">intuitive</span> from day one, and the more I use it,
                the better it <span className="italic text-pat-terra-600">understands my business</span>. It now
                saves me hours every week, time I put straight into work that grows the business.
              </blockquote>
              <figcaption className="mt-7">
                <span className="block font-serif text-xl text-pat-ink">Hunter Marckwald</span>
                <span className="mt-1 block text-sm uppercase tracking-[0.14em] text-pat-ink-500">
                  Founder &amp; CEO, Fourex
                </span>
              </figcaption>
